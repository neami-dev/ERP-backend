...
export class WarehousesController {
  ...
  @Post()
  @RequirePermissions(Permission.WAREHOUSES_CREATE)
  ...
  @Get()
  @RequirePermissions(Permission.WAREHOUSES_READ)
  ...
  @Patch(':id')
  @RequirePermissions(Permission.WAREHOUSES_UPDATE)
  ...
  @Delete(':id')
  @RequirePermissions(Permission.WAREHOUSES_DELETE)
